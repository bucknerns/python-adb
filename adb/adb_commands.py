...
try:
    ...
    from adb.sign_m2crypto import M2CryptoSigner # noqa:
except ImportError:
...
class AdbCommands(object):
    ...
    def Install(self, apk_path, destination_dir='', timeout_ms=None):
        ...
        Doesn't support verifier file, instead allows destination directory to
        be overridden.
    ...
    def Push(self, source_file, device_filename, mtime='0', timeout_ms=None):
        ...
        Args:
          source_file: Either a filename, a directory or file-like object to
            push to the device.
